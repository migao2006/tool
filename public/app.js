...
const S={
  ...
  mineSub:'watch',session:null,isAdmin:false,adminRoleChecked:false,watchlistGroupId:null,dataStatus:{},sourceDates:{},fundDates:{},syncState:'本機模式'
};
...
if('serviceWorker'in navigator)navigator.serviceWorker.register('/sw.js?v=19.0.1',{updateViaCache:'none'}).catch(()=>{});
