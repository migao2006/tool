"""Land a bounded FinMind historical daily-bar batch in Supabase staging."""
...
from src.data.ingestion.historical_daily_bar_import import (  # noqa: E402
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Import explicit FinMind symbols into research-only landing tables."
    )
