"""Import unresolved current MOPS TWSE listing-identity evidence."""
...
from src.data.ingestion.twse_current_listing_identity_import import (  # noqa: E402
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Import unresolved current MOPS TWSE listing evidence."
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        summary = TwseCurrentListingIdentityImporter(
