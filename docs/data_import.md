...
26 筆 migration 已在獨立 $0 Supabase Staging 完整套用，並通過代表性資料升級與 rollback
演練；Production 仍維持原本 13 筆 migration，12 筆新 migration 尚未發布。因此 benchmark、
supplemental、evidence 與 feature workflow 的 Production feature gate 仍應保持關閉。
