"""Explicit availability policies for auditable price/volume features."""
...
def validate_availability_mode(value: str) -> AvailabilityMode:
    if value not in PRICE_VOLUME_AVAILABILITY_MODES:
...
def resolve_availability(
    *,
    ...
    if uses_hint:
        ...
        limitations.append(RESEARCH_SCHEDULING_HINT_REASON)
