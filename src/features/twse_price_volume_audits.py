"""Window construction and per-value audits for TWSE research features."""
...
from .twse_price_volume_calculations import (
...
from .twse_price_volume_contracts import FeatureValueAudit
from .twse_price_volume_input import CanonicalResearchBar, FeatureInputError
from .twse_price_volume_schema import TWSE_PRICE_VOLUME_FEATURE_NAMES
...
def build_feature_audits(
    *,
    ...
    if tuple(audits) != TWSE_PRICE_VOLUME_FEATURE_NAMES:
