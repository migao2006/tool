"""Input validation for TWSE price/volume research features."""
...
from .twse_price_volume_record_adapter import (
    MISSING,
...
def parse_canonical_bar(
    ...
    *,
    ...
    if market != "TWSE":
        hard_reasons.append("TWSE_MARKET_REQUIRED")
    ...
    if asset_type is not MISSING and asset_type is not None:
        ...
        if normalized_asset_type != "COMMON_STOCK":
            hard_reasons.append("TWSE_COMMON_STOCK_REQUIRED")
