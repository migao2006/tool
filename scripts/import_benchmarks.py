"""Import official current-month total-return benchmark closes."""
...
from src.data.ingestion.benchmark_import import BenchmarkImporter  # noqa: E402
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Import current official total-return benchmark closes."
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        summary = BenchmarkImporter(settings=ApiProviderSettings.from_env()).run(
