...
assert.equal(health.version, "16.1");
...
const appResponse = await worker.fetch(new Request("https://example.test/app.js?v=16.1"), {}, {});
...
const smartResponse = await worker.fetch(new Request("https://example.test/smart.js?v=16.1"), {}, {});
...
assert.equal(latestSnapshot.version, "16.1");
