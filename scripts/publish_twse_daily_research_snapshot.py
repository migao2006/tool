"""Train the frozen last-fold bundle and publish one latest research snapshot."""
...
from src.pipeline.twse_research_daily_inference import (  # noqa: E402
    TwseDailyResearchInference,
)
from src.pipeline.twse_research_model_bundle_io import (  # noqa: E402
    TwseResearchBundleReader,
)
from src.pipeline.twse_research_runner import twse_price_research_runner  # noqa: E402
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Fit the mechanically last validated TWSE fold and score the latest "
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        output = (
            ...
            / "research"
            / (
                f"twse-{snapshot.predictions[0].evaluation_scope.lower()}-"
