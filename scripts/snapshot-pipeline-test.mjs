...
assert.match(serviceWorker, /twss-v19\.0\.2/);
assert.match(indexHtml, /\?v=19\.0\.2/);
...
console.log("Snapshot pipeline tests passed: 25 mature-date gating, 45-day readiness, next-open runtime, final-cycle readiness, official open, and v19.0.2 cache busting");
