...
1,941,388 列、261,557,231 bytes，日期範圍為 2021-07-19～2026-07-17
（TWSE 1,080 檔、TPEX 607 檔），manifest 與 R2 完整性為 `PASS`。
這只代表原始封存完整，不代表資料已通過 point-in-time、公司行動或可交易性驗收。

目前 TWSE 排程的 1,080 檔已完成 raw archive；TPEX security master 有 891 檔，其中 607 檔已封存、284 檔仍待回補；ETF 尚未開始。這些是目前排程股票池進度，不是 point-in-time 歷史股票池完整度。
