...
const staleHours = Number.isFinite(staleHoursValue) && staleHoursValue > 0
  ? staleHoursValue
  : 72;
const calendarReadyHourTaipei = positiveIntegerEnvironment(
  "PREDICTION_CALENDAR_READY_HOUR_TAIPEI",
  17,
  23,
);
const calendarLookbackDays = positiveIntegerEnvironment(
  "PREDICTION_CALENDAR_LOOKBACK_DAYS",
  45,
  62,
);
