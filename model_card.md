...
> 最後核對：2026-07-19。真實研究 workflow：[`29690820942`](https://github.com/migao2006/tool/actions/runs/29690820942)，Git commit `1c900c6873337606ac197332d6d9c84bdbf3ee08`。動態資料與阻塞現況見 [`docs/current-status.md`](docs/current-status.md)。
...
本次研究 label 為 `twse-research-unadjusted-open-close-5d-v1`：個股使用 t+1 open 至第 5 個持有交易日 close，再扣 `tw_stock_swing_v1:base_cost`；TAIEX 基準仍是研究用 close-based 路徑。這個 label 尚未解決 point-in-time 公司行動與股票／基準路徑一致性，不是正式 executable total-return LabelFactory 產物。
